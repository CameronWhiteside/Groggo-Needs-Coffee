const Lorem = ({ chars }) => {
    ...
    Groggo needs coffee as badly as Cameron Whiteside needs a job, and only you can fix that!
     Each map begins as a weighted graph of 2,450 nodes represented by a 35 x 70 grid. Each pair of orthogonally and diagonally adjacent nodes are joined by an edge with
